...
export default function Home() {
  ...
  return (
    <div className="flex flex-col justify-center items-center px-4 sm:px-14">
      ...
      {/* section  7 */}
      <div className="relative flex w-full bg-cream rounded-3xl mt-48 mb-10">
        <div className="p-6 lg:p-16">
          ...
          <p className="text-gray text-sm mt-4 mb-6 max-w-md">
            درگلدان، ما می دانیم که انتخاب گیاهان مناسب برای فضای شما می تواند
            یک کار دلهره آور باشد. به همین دلیل است که ما خدمات مشاوره شخصی
            گیاهی را برای کمک به شما در تصمیم گیری آگاهانه در مورد فضای سبز
            داخلی و خارجی خود ارائه می دهیم.
          </p>
          <button className="bg-orange text-white py-4 px-10 rounded-full text-sm md:text-base md:px-7">
            با ما تماس بگیرید
          </button>
